# Convert PNG to WEBP using XnView MP
...
1. Select **Tools**, then click **Batch convert**.
    ...
    ![Batch convert menu](convert-png-to-webp-01.webp)

2. In the **Input** tab, click **Add folder**, then select the folder containing PNG files.

    ![Add input folder](convert-png-to-webp-02.webp)
...
6. Click **Convert**.
    ...
    ![Output settings and convert](convert-png-to-webp-03.webp)
