...
1. Press **Ctrl + Shift + X** to open the **Extensions** view, then search for **“WSL” by Microsoft**.
    ...
    ![Screenshot](00-images/add-image-to-folder01.png)

2. Install the extension.

    ![Screenshot](00-images/add-image-to-folder02.png)
...
2. Select **Connect to WSL**.
    ...
    ![Screenshot](00-images/add-image-to-folder03.png)

3. Check the following two indicators:

    ![Screenshot](00-images/add-image-to-folder04.png)
